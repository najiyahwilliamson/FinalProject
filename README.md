...
To **synchronize** the project's package library with the versions recorded in renv.lock, be sure to type "make install" into the bash terminal.
This uses renv::restore() to install the required packages and ensure your own environment matches the project configuration, while making the file.
